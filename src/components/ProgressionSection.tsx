      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="spatial-container relative h-96 flex items-center justify-center overflow-x-auto md:overflow-visible snap-x snap-mandatory md:snap-none scroll-smooth px-24 md:px-0">
          ...
          {ranks.map((rank, index) => (
            <div
              key={rank.name}
              className={`badge-container ${rank.glow}-glow snap-center flex-shrink-0 transition-all duration-[250ms] ease-out hover:scale-[1.15] hover:-translate-y-[5px] hover:brightness-[1.2] cursor-pointer`}
              style={{
                transform: `
